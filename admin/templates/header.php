												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
															...
															<div class="menu-item">
																<!--begin:Menu link-->
																<a class="menu-link active" href="http://localhost/farmhub/admin/categories.php">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
																	<span class="menu-title">Categories11111</span>
																</a>
																<!--end:Menu link-->
															</div>
															<!--end:Menu item-->
													...
													<div class="menu-sub menu-sub-accordion">
														...
														<div class="menu-item">
															...
															<a class="menu-link active" href="http://localhost/farmhub/admin/categories.php">
																...
																<span class="menu-title">Categories111</span>
															</a>
															<!--end:Menu link-->
														</div>
														<!--end:Menu item-->
